...
if (block1StartIndex !== -1 && block1EndIndex !== -1) {
    ...
    console.log("Block 1 substitution complete.");
} else {
    console.error("Pattern mismatch for Block 1. Substitution failed.");
}

// --- BLOCK 2: DAILY CHECK-IN & QUESTS ---
// Centralizing UI updates in renderDashboardProfile
...
if (block2StartIndex !== -1 && block2EndIndex !== -1) {
    ...
    console.log("Block 2 substitution complete.");
} else {
    console.error("Pattern mismatch for Block 2. Substitution failed.");
}

fs.writeFileSync(filePath, content, 'utf8');
console.log("main.js successfully reconstructed.");
