...
# --- Patching index.html ---
file_path = r"e:\Swasthya Saathi AI Draft BKP - Copy\index.html"
...
replacements = [
    ...
    (
        '<li><a href="#" data-target="quests-page" style="color:var(--secondary); font-weight:700;"><i\n              class="ph-fill ph-star"></i> Health Quests</a></li>',
        '<li><a href="#" data-target="quests-page" style="color:var(--secondary); font-weight:700;"><i class="ph-fill ph-star"></i> <span data-i18n="nav_quests">Health Quests</span></a></li>'
    ),
    # Some environments have space differences, so let's use simpler replaces
    (
    ...
    ('<h4>Hydration Hero</h4>', '<h4 data-i18n="quest_1_title">Hydration Hero</h4>'), # Need to check if h4 has style
    ...
    ('Complete 1 Telemedicine consultation this\n                    week.', 'Complete 1 Telemedicine consultation this week.'),
...
# One more fix because of indentation in weekly milestones
html = html.replace(
    'Complete 1 Telemedicine consultation this\n                    week.', 
    '<span data-i18n="quest_w1_desc">Complete 1 Telemedicine consultation this week.</span>'
)
